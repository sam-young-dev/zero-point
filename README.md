...
* [Edit the homepage](https://github.com/sam-young-dev/zero-point/edit/master/src/pages/index.njk)
* [Create a new page](https://github.com/sam-young-dev/zero-point/new/master/?filename=/src/pages/&value=---%0Atitle%3A%20Enter%20page%20title%20here%0A---)
...
#### Posts
Blog posts
* [Create a new post](https://github.com/sam-young-dev/zero-point/new/master/?filename=/src/posts/&value=----%0Atitle%3A%20%22Enter%20post%20title%22%0Adate%3A%20%222025-01-01%0A---)
...
* [Edit the navigation](https://github.com/sam-young-dev/zero-point/edit/master/src/data/navigation.json)
...
* [Edit your branding](https://github.com/sam-young-dev/zero-point/edit/master/src/assets/styles/_branding.scss)
* [Edit your overall styles](https://github.com/sam-young-dev/zero-point/edit/master/src/assets/styles/styles.scss)
...
* [Add Javascript](https://github.com/sam-young-dev/zero-point/edit/master/src/assets/scripts/main.js)

</details>

## Step 3: Deploy zero-point!
<details open>
  <summary>Click here to expand/collapse Step 3: Deploy!</summary>

### Launch your zero-point on Netlify for Free!
...
---
# Get to Know zero-point
Ready to go deeper? Here's how zero-point is laid out:

```sh
example.com                 # → Root of your zero-point-based project
...
├── README.template               # → zero-point readme (automatically removed when this template is used)
